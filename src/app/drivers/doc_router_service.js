...
.factory('DocRouterService', function($state, MyDriverService) {
  ...
  var docOrder = {
    ...
    driver_license_image: 'driverAccount.newBooking.uploadDriverLicense',
    fhv_license_image: 'driverAccount.newBooking.uploadFhvLicense',
    defensive_cert_image: 'driverAccount.newBooking.uploadDefensiveCert',
    address_proof_image: 'driverAccount.newBooking.uploadAddressProof',
  }
